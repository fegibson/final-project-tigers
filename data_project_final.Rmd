...
conflict_df_clean <- 
  ...
  mutate(perception_why_tigers_attack_humans =
         as.factor(perception_why_tigers_attack_humans))
```
...
cbPalette <- c("#663300", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
